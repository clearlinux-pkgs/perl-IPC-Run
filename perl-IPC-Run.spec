...
%prep
%setup -q -n IPC-Run-20231003.0
cd %{_builddir}/IPC-Run-20231003.0
pushd ..
cp -a IPC-Run-20231003.0 buildavx2
popd
...
cp %{_builddir}/IPC-Run-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-IPC-Run/10b18134d80c6f0904ad1c836170dedb386d3533 || :
if test -f Makefile.PL; then
...
/usr/share/man/man3/IPC::Run::Win32Process.3
